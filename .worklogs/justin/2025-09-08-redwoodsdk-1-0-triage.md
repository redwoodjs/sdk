...
- **Rationale:** This breaks a fundamental React pattern that users expect to work. Teachers like Marius are building courses around these patterns, and students are running into this issue. Undermines confidence in the framework's RSC implementation.
- **Label:** `1.0-beta`
