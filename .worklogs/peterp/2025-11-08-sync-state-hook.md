...
7. Found the `useSyncState` tests still short-circuited because `window` is undefined under Vitest; updated the hook factory to keep running when custom dependency overrides are provided.
