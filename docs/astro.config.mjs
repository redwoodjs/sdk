          ...
          items: [
            {
              ...
              items: [
                ...
                {
                  label: "Data and State Management",
                  slug: "guides/routing/data-state",
                },
                {
                  label: "Common Routing Patterns",
                  items: [
                    {
                      label: "Onboarding Flow",
                      slug: "guides/routing/onboarding-flow",
                    },
                    {
                      label: "Multi-Step Form",
                      slug: "guides/routing/multi-step-form",
                    },
                    {
                      label: "Modal Routes",
                      slug: "guides/routing/modal-routes",
                    },
                    {
                      label: "Tabs with Routes",
                      slug: "guides/routing/tabs-with-routes",
                    },
                  ],
                },
                {
                  ...
                  items: [
                    {
                      label: "Implement View transitions",
                      slug: "guides/routing/view-transitions",
                    },
                    {
                      label: "Optimize route loading (progress bar)",
                      slug: "guides/routing/route-loading",
                    },
                    {
                      label: "Handle back/forward navigation",
                      slug: "guides/routing/back-forward-nav",
                    },
                  ],
                },
              ],
            },
            {
              ...
              items: [
                ...
                {
                  label: "Working with d1 Database",
                  slug: "guides/db-data/d1",
                },
              ],
            },
            {
              ...
              items: [
                {
                  ...
                  slug: "guides/auth/setup",
                },
                {
                  label: "Managing User Sessions",
                  slug: "guides/auth/sessions",
                },
                {
                  label: "Role-Based Access Control",
                  slug: "guides/auth/rbac",
                },
              ],
            },
            {
              ...
              items: [
                {
                  ...
                  slug: "guides/frontend/react-server-components",
                },
                { label: "Form Handling", slug: "guides/frontend/forms" },
                {
                  label: "Setting up Tailwind CSS",
                  slug: "guides/frontend/tailwind",
                },
                {
                  label: "Integrating with ShadCN UI",
                  slug: "guides/frontend/shadcn",
                },
                {
                  label: "Customizing Layouts",
                  slug: "guides/frontend/layouts",
                },
              ],
            },
            {
              ...
              collapsed: true,
              items: [{ label: "API Routes", slug: "guides/backend/api" }],
            },
            {
              ...
              items: [
                ...
                {
                  label: "Setting up OpenAI Integration",
                  slug: "getting-started/installation",
                },
                {
                  label: "Setting up Anthropic Integration",
                  slug: "getting-started/installation",
                },
                {
                  label: "Setting up Gemini Integration",
                  slug: "getting-started/installation",
                },
                {
                  label: "Working with Cloudflare AI",
                  slug: "getting-started/installation",
                },
                {
                  label: "Building AI Powered Features",
                  slug: "getting-started/installation",
                },
                {
            ...
            },
            {
              ...
              items: [
                ...
                {
                  label: "Setting up a Custom Domain",
                  slug: "getting-started/installation",
                },
                {
                  label: "Working with Cloudflare r2",
                  slug: "getting-started/installation",
                },
              ],
            },
            {
              ...
              items: [
                {
                  label: "Setting up a Testing Environment",
                  slug: "getting-started/installation",
                },
