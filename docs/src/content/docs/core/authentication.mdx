...
The passkey starter implements passkeys/[webauthn]()https://en.wikipedia.org/wiki/WebAuthn-based authentication.

### **How It Works**

1. Registration creates a public-private key pair - user interacts with their browser/authenticator (1Password, Google PassKeys) to store the private key
