...
import importedCodeStandardLogin from "../../../../../starters/standard/src/app/pages/auth/Login.tsx?raw";
...
3. Copy your **Site Key** into your application's [`Login.tsx`](https://github.com/redwoodjs/sdk/blob/main/starters/standard/src/app/pages/auth/Login.tsx#L17):
...
<Code
  language="typescript"
  title="src/app/pages/auth/Login.tsx"
