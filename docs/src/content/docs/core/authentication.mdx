...
3. Copy your **Site Key** into your application's [`LoginPage.tsx`](https://github.com/redwoodjs/sdk/blob/main/starters/standard/src/app/pages/auth/LoginPage.tsx#L17):
