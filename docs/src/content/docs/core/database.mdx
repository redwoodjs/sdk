...
@redwoodjs/sdk is built to work on the Cloudflare Developer Platform. D1 is Cloudflare's managed, serverless database with SQLite's SQL semantics, built-in disaster recovery, and a generous free tier.
...
@redwoodjs/sdk ships with a [Prisma starter project](https://github.com/redwoodjs/sdk/tree/main/starters/prisma), you can use it to get started with a database in seconds.
