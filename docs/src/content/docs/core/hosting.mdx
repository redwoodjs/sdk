...
<Aside type="tip" title="Pick your poison">
  You do not need to use Cloudflare's Developer Platform, you can use any bare-metal hosting provider you want, but we recommend
...
Ship your website to Cloudflare with the following command:
