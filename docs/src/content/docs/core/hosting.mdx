...
![](../tutorial/full-stack-app/images/cloudflare-visit-website.png)
...
![](../tutorial/full-stack-app/images/connecting-to-custom-domain.png)

Click on the **+ Add** button at the top of the **Domains & Routes** table. A side panel will appear:

![](../tutorial/full-stack-app/images/side-panel-custom-domain.png)

Click on the **Custom Domain** option. Then, it will ask you enter the domain name you want to use.

![](../tutorial/full-stack-app/images/existing-domain-name-in-cloudflare.png)
...
![](../tutorial/full-stack-app/images/project-live-custom-domain.png)
...
![](../tutorial/full-stack-app/images/cloudflare-delete-project.png)

A confirmation modal will appear, asking you to type the name of your project, then click on the **Delete** button.

![](../tutorial/full-stack-app/images/cloudflare-confirm-project-delete.png)