...
```diff
// In app/headers.ts
const { headers, rw: { nonce } } = requestContext;
  ...
  return (
    <html lang="en">
      ...
      <body>
        ...
        {/* Set the nonce for the inline script */}
