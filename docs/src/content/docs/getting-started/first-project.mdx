...
This guide is designed for developers who are already comfortable with JavaScript frameworks and are looking to quickly understand @redwoodjs/sdk's organization and conventions.
...
The @redwoodjs/sdk is tightly coupled to Cloudflare's services. This means that you'll need to have a [Cloudflare account](https://www.cloudflare.com/plans/) to deploy your project.
