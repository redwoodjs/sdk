...
- [Minimal](https://github.com/redwoodjs/sdk/tree/main/starters/minimal)
- [Prisma](https://github.com/redwoodjs/sdk/tree/main/starters/prisma)
- [Prisma & Authentication](https://github.com/redwoodjs/sdk/tree/main/starters/passkey-auth)
</Aside>
...
Modify the `Home` component to say "My Personal Website" instead of "Hello World". When you save the file, the development server will automatically reload the page.
