...
import importedCodeMinimalWorker from "../../../../../starters/minimal/src/worker.tsx?raw";
...
<Code
  ...
  code={importedCodeMinimalWorker}
...
This guide uses the [minimal starter](https://github.com/redwoodjs/sdk/tree/main/starters/minimal), perfect for getting up and running in both development and production quickly. If you'd prefer something with authentication and database scaffolding already set up, check out the [standard starter](https://github.com/redwoodjs/sdk/tree/main/starters/standard).
