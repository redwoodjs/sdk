...
<Aside type="tip">
  If you want to use the standard starter, replace `minimal` with `standard`.
  The production deployment requirements are slightly different in that you'll
  have to [create a database](/core/database#setup) first.
</Aside>
