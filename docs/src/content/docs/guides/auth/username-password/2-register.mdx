...
Of course, we'll also need to import `useState` at the top of the file.

```tsx title="src/app/pages/auth/RegisterPage.tsx"  startLineNumber={1}
...
```tsx title="src/app/pages/auth/RegisterPage.tsx"  startLineNumber={91}
