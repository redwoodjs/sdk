...
2. Add Component Snippets
   ...
   This command will prompt you to select which snippets to add. You can add all snippets or choose specific ones. Snippets will be added to `src/components/ui/` directory.
...
6. Set Up the Provider
   ...
   ```tsx title="src/app/Document.tsx" ins={2, 7, 9}
