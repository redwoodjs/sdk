...
For server-side rendering errors, use the router's error handling (see [router error handling documentation](/reference/sdk-router/#error-handling)).
...
- Server-side RSC rendering errors (use [router error handling](/reference/sdk-router/#error-handling) or wrap `defineApp`'s `fetch` method)
- Router-level errors (use [router error handling](/reference/sdk-router/#error-handling) or wrap `defineApp`'s `fetch` method)
