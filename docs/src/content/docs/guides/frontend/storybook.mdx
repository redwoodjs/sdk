...
6. Save it, and go back to your Storybook site. You should see a new dropdown for the `ctx` prop — give it a try!
...
<Steps>
1. If you're also using the standard starter, then the only thing in your database schema is a list of users. What's the most obvious thing to do? List out all the users! Add this to your `Home` component:
