...
{/* TODO: Claude's recommendation. If we end up writing this content, I think it would make sense to move each section into it's own page. IMHO, the right sidebar nav is overwhelming. */}
