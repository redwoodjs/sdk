...
The `1.x` release line includes significant improvements, including a simplified starter template, an officially supported passkey addon, and numerous bug fixes and performance enhancements.
