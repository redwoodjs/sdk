...
I've also exported all the images from the Figma file and packaged them together. You can find them [here](https://github.com/ahaywood/applywize/tree/main/assets).
...
<Aside type="tip" title="Code on GitHub">
  You can find the final code on
  [GitHub](https://github.com/ahaywood/applywize).
</Aside>
