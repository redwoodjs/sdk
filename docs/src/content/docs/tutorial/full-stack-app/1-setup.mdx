...
sidebar:
  label: Setup
description: Learn to build a complete job application tracker using RedwoodSDK. This tutorial covers database design, authentication, and deployment - perfect for developers new to full-stack development.
---
...
At Redwood, we believe AI will revolutionize how people build applications. Personal software has the power to transform our daily lives. Applywize is a perfect example of this transformation - if you're searching for a new job, you need a tool to help manage all your opportunities.
...
<Aside type="caution" title="Need Support?">
If you get stuck, don't worry! We're here to help. You can reach out to us on [Discord](https://discord.gg/redwoodjs) or [GitHub](https://github.com/redwoodjs/applywize).
</Aside>
...
- [Cloudflare account](https://www.cloudflare.com/plans/) for deploying (last lesson). They have a generous free tier that should include everything you need to follow along.
- [Node.js](https://nodejs.org/en/download/) version 22 or later installed on your machine.
  You can see what version of Node you're using by running `node -v` in your terminal.
...
<Aside type="note" title="What's Next?">
In the next lesson, you'll:

- Generate your Applywise project using the RedwoodSDK starter
- Explore the project structure and understand how the files work together
- Set up TailwindCSS for styling your application
- Install shadcn/ui components for building professional-looking interfaces
- Configure custom fonts and colors to match our design
- Test everything works by creating your first styled component

By the end of the next lesson, you'll have a fully configured development environment with all the tools needed to build modern, beautiful web applications. You'll also see your first RedwoodSDK page running in the browser!
</Aside>