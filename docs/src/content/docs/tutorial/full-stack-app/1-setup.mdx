...
All UI designs for Applywize are available in Figma. You can view the complete design system, component library, and page layouts. This will help you understand how the final application should look and function before we start building. [Access the Figma design online](https://www.figma.com/design/nqBPIIfe0MO4W8zOfW4oae/Redwood-Reloaded-Tutorial?node-id=1-3&t=9gzbWUrBb2G3qdoa-1) or [download the Figma file]().

{/* TODO: add a link to download the Figma file */}

I've also exported all the images from the Figma file and packaged them together in a single zip file. You can download it [here]().

{/* TODO: add a link to download all the design assets */}
