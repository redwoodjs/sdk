...
<Aside type="note" title="Starter Projects">
  For the tutorial, we're starting with the [Pass Key Auth starter project](/reference/starters/passkey-auth/). However, when you start building your own projects, if you start with a different template, the files and folders may vary slightly.
</Aside>
