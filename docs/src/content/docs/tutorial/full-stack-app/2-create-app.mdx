...
<Aside type="note" title="Starter Projects">
  For the tutorial, we're starting with the [Pass Key Auth starter project](/reference/starters/passkey-auth/). However, if you start with a different template, the files and folders may vary slightly.
</Aside>
...
4. Now, you can run `pnpm run dev` and the "Hello World" text should look different.
    ...
    {/* TODO: Add a screenshot of the Hello World page */}
    ![]()
...
7. You should now be able to add components:
    ...
    This will add all the components inside the `src/app/components/ui` folder.
</Steps>
