...
```tsx title="src/app/components/ApplicationForm.tsx" startLineNumber=1
<form>
...
```css title="src/app/styles.css" startLineNumber={250}
h2 {
...
```css title="src/app/styles.css" startLineNumber={276}
.field {
  @apply pt-8;
}
---
...
```css title="src/app/styles.css" startLineNumber={254}
label, .label {
...
```css title="src/app/styles.css" startLineNumber={258}
textarea,
input[type="email"],
input[type="date"],
input[type="url"],
...
```css title="src/app/styles.css" startLineNumber={266}
textarea {
  @apply h-[80px] py-3;
}
---
...
```css title="src/app/styles.css" startLineNumber={297}
.label-inside {
...
```css title="src/app/styles.css" startLineNumber={296} {3-4}
.label-inside {
...
```css title="src/app/styles.css" {5-7} startLineNumber={296} collapse={2-4}
.label-inside {
  @apply relative flex border outline-1 outline-white border-border rounded-md mb-2 h-9;
  label { @apply text-sm font-medium px-3 bg-[#f4f4f5] rounded-sm center my-1 ml-1; }
  input[type="text"] { @apply border-none flex-1 relative -top-[2px] outline-none focus:border-none focus:outline-none h-auto; }
...
```css title="src/app/styles.css" startLineNumber={303}
.input-description {
...
```tsx title="/src/app/pages/applications/New.tsx" startLineNumber=4
import { db } from "@/db"
...
```tsx title="/src/app/pages/applications/New.tsx" startLineNumber={28}
<ApplicationsForm statuses={statuses} />
```

Now, we need to set up our `ApplicationForm` to receive the data:

```tsx title="/src/app/components/ApplicationForm.tsx" startLineNumber=6 "({ statuses }: { statuses: ApplicationStatus[] })"
...
```tsx title="/src/app/components/ApplicationForm.tsx" {6, 8} startLineNumber={67}
<Select name="statusId">
  <SelectTrigger>
    <SelectValue placeholder="Select a Status" />
  </SelectTrigger>
...
```css title="/src/app/styles.css" startLineNumber="307"
.box {
...
```tsx title="/src/app/pages/applications/actions.ts" startLineNumber={3}
