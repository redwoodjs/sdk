...
<header>
  ...
  <div>
    <Button asChild><a href={application?.postingUrl as string} target="_blank">View Application <Icon id="external-link" size={16} /></a></Button>
  </div>
</header>
---
...
```tsx title="/src/app/pages/applications/Details.tsx" startLineNumber={51} "className="flex items-center gap-2"""
