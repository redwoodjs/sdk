...
export default defineScript(async () => {
  ...
  await db.invoice.create({
    data: {
      ...
      notesA: "Bank account number 123-456-789, SWIFT: BKCHCNBJ110, IBAN: GB29 NWBK 6016 1331 9268 19",
      items: JSON.stringify([
        { description: "Professional Web Development Services", price: 1200.0, quantity: 1 },
  ...
  await db.invoice.create({
    data: {
      ...
      items: JSON.stringify([
        ...
        { description: "Cloud Infrastructure Setup", price: 1200.0, quantity: 1 },
      ]),
  ...
  await db.invoice.create({
    data: {
      userId: user.id,
      number: "3",
      customer: "Marketing Masters LLC\nAttn: John Smith\n555 Commerce St\nBusiness City, BZ 54321",
      supplierName: "Global Supplies Ltd",
      supplierContact: "123 Business Ave, Suite 400, Metro City, ST 12345",
      items: JSON.stringify([
        { description: "Digital Marketing Campaign", price: 2500.0, quantity: 1 },
