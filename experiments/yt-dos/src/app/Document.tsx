...
export const Document: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <html lang="en">
    <head>
      ...
      <meta name="description" content="YT-DOS is a minimalistic YouTube search tool to combat social media scrolling." />
      <meta name="keywords" content="YouTube, search, social media, scrolling, minimalistic, DoS" />
