...
import { createSyncedStateHook } from "rwsdk/use-synced-state/hibernation/client";
import type { SyncedStateStatus } from "rwsdk/use-synced-state/hibernation/client";
