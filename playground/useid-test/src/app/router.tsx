import { createRouter } from "rwsdk/router";
import ServerOnlyPage from "./pages/ServerOnlyPage.js";
import ClientOnlyPage from "./pages/ClientOnlyPage.js";
import MixedPage from "./pages/MixedPage.js";
...
const router = createRouter({
  ...
  "/server-only": () => <ServerOnlyPage />,
  "/client-only": () => <ClientOnlyPage />,
  "/mixed": () => <MixedPage />,
});
