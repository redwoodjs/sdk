...
if ! VERBOSE=1 DEBUG='rwsdk:vite:react-conditions-resolver-plugin' pnpm smoke-test --path="$PROJECT_DIR" --no-sync --artifact-dir="$TEMP_DIR/artifacts" --skip-style-tests --keep; then
