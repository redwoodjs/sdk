...
import "${projectRootDir}/src/component.tsx";`;
  ...
  describe("barrel module loading integration", () => {
    it("should allow named exports to be accessed via the barrel's default export", async () => {
      ...
      writeFileSync(
        path.join(libADir, "index.js"),
        "export const componentA = 'A';\nexport const utilA = 'util-a';",
      );
      writeFileSync(
        path.join(libBDir, "component.js"),
      ...
      const loadableBarrelContent = barrelContent
        .replace(
          /from '\/node_modules\/lib-a\/index.js'/g,
          "from './node_modules/lib-a/index.js'",
        )
        .replace(
          /from '\/node_modules\/lib-b\/component.js'/g,
          "from './node_modules/lib-b/component.js'",
        );
